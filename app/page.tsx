    ...
    <div className="section-padding">
      ...
      <header className="text-center hero-gradient rounded-2xl section-padding mb-16">
        ...
        <p className="text-xl text-afh-blue/80 mb-8 max-w-3xl mx-auto">
          Artists For Humanity harnesses the power of mentorship and paid
          professional experiences to inspire teens to build their future
        ...
        <div className="gallery-grid">
          ...
          {[1, 2, 3, 4, 5, 6].map(item => (
            <div key={item} className="card card-hover animate-slide-up">
              ...
              <div className="p-6">
                <h3 className="font-semibold text-afh-blue mb-2">
                  Sample Artwork Title
                </h3>
                <p className="text-sm text-afh-blue/70 mb-3">
                  by Student Artist
                </p>
                <p className="text-sm text-afh-blue/60">
                  Adobe Illustrator • Client Project
                </p>
              </div>
            </div>
          ))}
      ...
      <section className="gallery-grid mb-16">
        <div className="card p-8 text-center">
          ...
          <p className="text-afh-blue/70">
            Build your professional portfolio while gaining real-world
            experience through paid creative projects and mentorship.
          </p>
        </div>
        ...
        <div className="card p-8 text-center">
          ...
          <p className="text-afh-blue/70">
            Connect with talented teen artists to bring your creative vision to
            life while supporting youth development in Boston.
          </p>
        </div>
        ...
        <div className="card p-8 text-center">
          ...
          <p className="text-afh-blue/70">
            Transcending economic, racial and social divisions to transform
            communities through the power of creative expression.
          </p>
        </div>
      </section>
    </div>
