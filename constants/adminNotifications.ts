...
export const NOTIFICATION_TEMPLATES = {
  approve: {
    ...
    message: (title: string) => `Great news! Your artwork "${title}" has been approved and is now live on AFH Digital Archive.`,
  ...
  reject: {
    ...
    reasons: {
      quality: "Image quality is too low. Please upload a higher resolution version.",
      inappropriate: "Content doesn't align with AFH community guidelines.",
      copyright: "Potential copyright concern. Please ensure all work is original.",
  ...
  feature: {
    ...
    message: (title: string) => `Congratulations! Your artwork "${title}" has been featured on the homepage.`,
  ...
  reassign: {
    ...
    message: (title: string) => `The artwork "${title}" has been assigned to your account.`,
